...
function showLandingPage() {
  ...
  const exploreFlutterButton = document.getElementById('explore-flutter-button');
  if (exploreFlutterButton) {
    exploreFlutterButton.disabled = false;
    exploreFlutterButton.classList.remove('disabled');
  }
}

function showButtonLoader(loadingTextContent = 'Loading flutter...') {
  const button = document.getElementById('explore-flutter-button');
...
window.startApp = function() {
  showButtonLoader('Loading flutter...');
